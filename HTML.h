...
//stores HTML pages into strings
...
<body style="background-color: tomato;">
  <h1 style="font-size: 50px;">Smart Remote</h1>
  ...
  <div>
    <input type="button" id="pwr" value="power" onclick="on_click(this.id)"> </input>
  </div>

  <div style="padding-top: 5px">
    <input type="button" id="stgs" value="settings" onclick="on_click(this.id)"> </input>
    <input type="button" id="src" value="source" onclick="on_click(this.id)"> </input>
  </div>
  
  <div style="padding-top: 15px">
    <input type="button" id="ok" value="ok" onclick="on_click(this.id)"> </input>
    <input type="button" id="bck" value="back" onclick="on_click(this.id)"> </input>  
  </div>
    
  <div style="padding-top: 15px">
    <input type="button" id="vu" value="volume up" onclick="on_click(this.id)"> </input>
  </div>

  <div style="padding-top: 5px">
    <input type="button" id="vd" value="volume down" onclick="on_click(this.id)"> </input>
  </div>

  <div style="padding-top: 15px">
    <input type="button" id="up" value="up" onclick="on_click(this.id)"> </input>
  </div>

  <div style="padding-top: 5px">
    <input type="button" id="lft" value="left" onclick="on_click(this.id)"> </input>
    <input type="button" id="rht" value="right" onclick="on_click(this.id)"> </input>
  </div>

  <div style="padding-top: 5px">
    <input type="button" id="dwn" value="down" onclick="on_click(this.id)"> </input>
  </div>
...
String connectPage = R"rawliteral(
<!DOCTYPE html>
<html>

<head>
 <title>Smart Remote Connect</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
</head>

<body style="background-color: tomato;">
  <h1 style="font-size: 50px;">Smart Remote Connect</h1>
...
<form action="/connect">
    ...
    <br>
    <input type="text" id="ssid" name="ssid"></input>
    <br>
